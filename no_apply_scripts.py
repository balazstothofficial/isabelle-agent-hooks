...
(`apply ...`). Covers Write / Edit / MultiEdit / Bash, Codex's apply_patch, the
iq-dev MCP write_file/save_file, and the isabelle-pide-mcp `edit` tool. Non-theory
writes are never blocked. Fails OPEN on internal errors.
"""
import sys, re
try:
